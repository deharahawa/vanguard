...
export function IntelCard({ data, initialSaved = false }: { data: IntelCardData; initialSaved?: boolean }) {
    ...
    return (
        <div className="relative w-full h-full flex flex-col justify-center p-6 md:p-12 overflow-hidden bg-black snap-center">
            ...
            {/* Content Container */}
            <div className="relative z-10 w-full max-w-2xl mx-auto space-y-6 mb-12 md:mb-0">
                {/* Header */}
                <div className="flex items-center gap-3 animate-in slide-in-from-bottom-8 duration-700 delay-100">
                    ...
                    <div className="space-y-1">
                        ...
                        >
                         ...
                         <h1 className="text-3xl md:text-4xl font-black text-white leading-tight tracking-tight shadow-black drop-shadow-lg">
                            {data.title}
                        </h1>
                    </div>
                </div>
                ...
                {/* Body */}
                <p className="text-zinc-300 text-lg md:text-xl font-medium leading-relaxed max-w-prose drop-shadow-md animate-in slide-in-from-bottom-8 duration-700 delay-200">
                    {data.content}
                </p>

                {/* Actions & Read More */}
                <div className="flex items-center gap-4 pt-4 animate-in slide-in-from-bottom-8 duration-700 delay-300">
                    {/* Read More Trigger */}
                    {data.referenceUrl && (
                        <Drawer.Root>
                            <Drawer.Trigger asChild>
                                <button className="px-6 py-3 bg-white/10 hover:bg-white/20 backdrop-blur border border-white/10 rounded-full text-white text-sm font-bold uppercase tracking-widest transition-all flex items-center gap-2 group">
                                    Read More
